...
public class frmLocalidades extends javax.swing.JInternalFrame {
    ...
    public frmLocalidades() {
        initComponents();
        jTableLocalidades.setModel(new Localidad().GetAllModel());
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        frmNuevaLocalidad obj = new frmNuevaLocalidad();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        if (jTableLocalidades.getSelectedRow() >= 0) {
            int idLocalidad = (int) jTableLocalidades.getValueAt(jTableLocalidades.getSelectedRow(), 0);
            String localidad = (String) jTableLocalidades.getValueAt(jTableLocalidades.getSelectedRow(), 1);
            String municipios = (String) jTableLocalidades.getValueAt(jTableLocalidades.getSelectedRow(), 2);
            frmNuevaLocalidad obj = new frmNuevaLocalidad(idLocalidad, localidad, municipios);
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        // TODO add your handling code here:
        jTableLocalidades.setModel(new Localidad().Asc());
    }//GEN-LAST:event_btnOrdenarActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        frmBuscar obj = new frmBuscar();
        obj.setTitle("Buscar por Localidad");
        obj.setModal(true);
        obj.setLocationRelativeTo(null);
        obj.setVisible(true);
    ...
    public static javax.swing.JTable jTableLocalidades;
