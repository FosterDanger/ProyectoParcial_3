 ...
 * @author FOSTER
 */
public class frmNuevaEntidad extends javax.swing.JDialog {
     ...
     */
    public frmNuevaEntidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public frmNuevaEntidad() {
        initComponents();
        //cboFar();
    }

    public frmNuevaEntidad(int idEntidad) {
        initComponents();

        this.idEntidad = idEntidad;
        entidad.setIdEntidad(idEntidad);
        entidad.GetById();
        txtNombre.setText(entidad.getEntidad());
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if (entidad.getIdEntidad() > 0) {
            entidad.setEntidad(txtNombre.getText());
            if (entidad.Update()) {
                JOptionPane.showMessageDialog(null, "Entidad actualizada correctamente");
                this.dispose();
            }
        } else {
            if (new Entidad(0,
                    txtNombre.getText()).Add()) {
                JOptionPane.showMessageDialog(null, "Entidad agregada correctamente!");
                this.dispose();
            }
...
//Este metodo agrega los datos del metodo RowData que retorna un arraylist y los coloca en el combo box.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNuevaEntidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmNuevaEntidad dialog = new frmNuevaEntidad(new javax.swing.JFrame(), true);
