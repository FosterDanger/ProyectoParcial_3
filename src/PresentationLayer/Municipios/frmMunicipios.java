...
public class frmMunicipios extends javax.swing.JInternalFrame {
    ...
    public frmMunicipios() {
        initComponents();
        jTableMunicipios.setModel(new Municipio().GetAllModel());
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        frmNuevoMunicipio obj = new frmNuevoMunicipio();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (jTableMunicipios.getSelectedRow() >= 0) {
            int idMunicipio = (int) jTableMunicipios.getValueAt(jTableMunicipios.getSelectedRow(), 0);

            frmNuevoMunicipio obj = new frmNuevoMunicipio(idMunicipio);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (jTableMunicipios.getSelectedRow() >= 0) {
            int idMunicipio = (int) jTableMunicipios.getValueAt(jTableMunicipios.getSelectedRow(), 0);
            Municipio muncipio = new Municipio();
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        // TODO add your handling code here:
        jTableMunicipios.setModel(new Municipio().Asc());
    }//GEN-LAST:event_btnOrdenarActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        frmBuscar obj = new frmBuscar();
        obj.setTitle("Buscar por Municipio");
        obj.setModal(true);
        obj.setLocationRelativeTo(null);
        obj.setVisible(true);
    ...
    public static javax.swing.JTable jTableMunicipios;
