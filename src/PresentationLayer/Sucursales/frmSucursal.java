...
public class frmSucursal extends javax.swing.JInternalFrame {
    ...
    public frmSucursal() {
        ...
        jTableSucursales.setModel(new Sucursal().GetAllModel());
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        frmNuevaSucursal obj = new frmNuevaSucursal();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (jTableSucursales.getSelectedRow() >= 0) {
            int idSucursal = (int) jTableSucursales.getValueAt(jTableSucursales.getSelectedRow(), 0);

            frmNuevaSucursal obj = new frmNuevaSucursal(idSucursal);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (jTableSucursales.getSelectedRow() >= 0) {
            int idSucursal = (int) jTableSucursales.getValueAt(jTableSucursales.getSelectedRow(), 0);
            int idContacto = (int) jTableSucursales.getValueAt(jTableSucursales.getSelectedRow(), 2);
            Sucursal sucursal = new Sucursal();
            Contacto contacto = new Contacto();
            sucursal.setIdSucursal(idSucursal);
            contacto.setIdContacto(idContacto);
            if (sucursal.Delete() && contacto.Delete()) {
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        // TODO add your handling code here:
        jTableSucursales.setModel(new Sucursal().Asc());
        jTableSucursales.getColumnModel().getColumn(2).setMaxWidth(0);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        obj.setTitle("Buscar por Sucursal");
        obj.setModal(true);
        obj.setLocationRelativeTo(null);
        obj.setVisible(true);
    ...
    public static javax.swing.JTable jTableSucursales;
