 ...
 */
package PresentationLayer.Sucursales;
 ...
 * @author FOSTER
 */
public class frmNuevaSucursal extends javax.swing.JDialog {
     ...
     */
    public frmNuevaSucursal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public frmNuevaSucursal(int idSucursal) {
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if (idSucursal == 0) {
            if (new Contacto(0, Integer.parseInt(txtCodPostal.getText()),
                    ...
                    (int) sucursal.Row(v3).get(0)).Add()) {
                sucursal.Row(v3).clear();
                llenarArryListIdContacto();
            }
            if (new Sucursal(0, txtNombre.getText(), idContacto.getLast()).Add()) {
            ...
            contacto.setIdLocalidad((int) sucursal.Row(v3).get(0));
            sucursal.Row(v3).clear();
            if (sucursal.Update() && contacto.Update()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNuevaSucursal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmNuevaSucursal dialog = new frmNuevaSucursal(new javax.swing.JFrame(), true);
